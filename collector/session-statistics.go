...
func NewSesstatCollector() (Collector, error) {
	...
	descs["parse count (hard)"] = newDesc("sesstat", "parse_hard_total", "Generic counter metric from v$sesstat view in Oracle.", []string{"serial", "username", "sid", "name", "class"}, nil)
	descs["parse count (failures)"] = newDesc("sesstat", "parse_failures_total", "Generic counter metric from v$sesstat view in Oracle.", []string{"serial", "username", "sid", "name", "class"}, nil)
	descs["parse count (describe)"] = newDesc("sesstat", "parse_describe_total", "Generic counter metric from v$sesstat view in Oracle.", []string{"serial", "username", "sid", "name", "class"}, nil)
	descs["parse time cpu"] = newDesc("sesstat", "parse_time_cpu_total", "Generic counter metric from v$sesstat view in Oracle.", []string{"serial", "username", "sid", "name", "class"}, nil)
	descs["parse time elapsed"] = newDesc("sesstat", "parse_time_elapsed_total", "Generic counter metric from v$sesstat view in Oracle.", []string{"serial", "username", "sid", "name", "class"}, nil)
